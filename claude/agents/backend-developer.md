...
```
Task(subagent_type="context-scout", description="Find Node.js coding standards for [feature]", prompt="Find documentation and comment standards, coding standards, security patterns, design patterns (GoF catalog for structural choices), naming conventions, and code smells/refactoring guidelines needed to implement [feature] in Node.js.")
```
