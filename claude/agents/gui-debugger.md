...
```
Task(subagent_type="context-scout", description="Find standards for GUI fix in [area]", prompt="Find documentation and comment standards, frontend conventions, component structure, styling approach, and accessibility rules for [affected component/page].")
```
