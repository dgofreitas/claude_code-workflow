...
```
Task(subagent_type="context-scout", description="Find frontend standards for [feature]", prompt="Find documentation and comment standards, component patterns, design tokens, accessibility standards, and styling conventions needed to implement [feature].")
```
